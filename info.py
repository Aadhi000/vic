...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('1979355984 5330554220', '').split()]
...
auth_channel = "-1001727392022"
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://FILO:FILO@cluster0.xzytvve.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "FILO")
